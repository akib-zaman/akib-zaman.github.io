...
const events = [
  ...
  { title: "Graduate Intern", subTitle: "Dell Technologies Inc.", date: "May 2021 - Aug 2021", description: "Dell Technologies Inc.", icon: dellPic, backgroundColor: "#f0e4d7" },
  { title: "Graduate Intern", subTitle: "Dell Technologies Inc.", date: "Jun 2020 - Jul 2020", description: "Dell Technologies Inc.", icon: dellPic, backgroundColor: "#f0e4d7" },
    ...
    <div>
      <div className="color-key-container">
        <div className="color-key">
          <span className="color-box" style={{ backgroundColor: "#edced6" }}></span> Academics
        </div>
        <div className="color-key">
          <span className="color-box" style={{ backgroundColor: "#f0e4d7" }}></span> Internships
        </div>
        <div className="color-key">
          <span className="color-box" style={{ backgroundColor: "#aee6b0" }}></span> Research
        </div>
      </div>
      <div className="timeline-container">
        {events.map((event, index) => (
          <div 
            ...
            key={index}
            style={{ backgroundColor: event.backgroundColor }} // Apply background color
          >
